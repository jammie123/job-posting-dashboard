...
export default function EshopV2Page() {
  ...
  const filteredCategories = activeCategory === "all" 
    ...
    : allItems.filter(category => {
        ...
        if (activeCategory === "nabor" && category.title === "Nábor a zpracování kandidátů") return true;
      ...
      <div className="pl-[60px] xl:pl-[140px]">
        ...
        <main className="container mx-auto px-6 py-8">
          ...
          {/* <div className="relative mb-8">
            ...
            <input
              type="search"
              className="block w-[300px] p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="rounded-lg flex flex-col gap-4">
                {filteredCategories.map((category, categoryIndex) => {
                  ...
                  const gridClassName = isInzerceCategory
                    ...
                    : "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"; // Standard grid for others
