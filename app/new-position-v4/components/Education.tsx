...
export function  Education({ 
  ...
  if (isViewMode && !isEditing) {
    return (
      <div className={`rounded-md flex relative group hover:bg-accent/5 transition-colors ${blurClass} flex flex-col gap-3 max-w-[300px]`}>
  ...
  return (
    <div className={`${blurClass} flex flex-col gap-3`}>
