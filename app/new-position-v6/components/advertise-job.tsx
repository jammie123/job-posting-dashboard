...
import { AdvertisementPlatformCard, type AdditionalSetting } from "@/components/advertisement-platform-card"
...
export function AdvertiseJob({
  ...
  }, [jobsSettings, careerSettings, onSettingsChange])
    ...
    <div className="flex">
      <div className="flex-1 overflow-auto">
        <div className="flex flex-col gap-2 w-full">
          ...
          {componentContext === "new" || hideSettings ? (
            ...
            <>
              ...
              <AdvertisementPlatformCard
                ...
                additionalSettings={hideSettings ? undefined : jobsAdditionalSettings}
              />
              ...
              <AdvertisementPlatformCard
                ...
                additionalSettings={hideSettings ? undefined : careerAdditionalSettings}
              />
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <AdvertisementPlatformCard
                    ...
                    additionalSettings={hideSettings ? undefined : profesiaAdditionalSettings}
                  ></AdvertisementPlatformCard>
              ...
              <Card className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors mt-4">
                <CardHeader className="flex flex-row items-center justify-center py-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500 font-normal">Vystavte svou pozici na další pracovní portály</p>
                  </Button>
                </CardHeader>
              </Card>
            </>
